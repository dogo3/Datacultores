...
Inciso: si el gasto aumenta, puede ser que gastes más como tal, o que te obliguen a gastar más (aumento de precios). En este caso se ve que ha sido principalmente por aumento en el consumo.
...
- Marcarnos un triple y añadir un dataset con una serie del IPC (esperemos que no suban, si no no hay triple)
