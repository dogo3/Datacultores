...
```{r}
ggplot(data=filter(dfPreciosAndalucia,SUBSECTOR=="Citricos"),aes(x=INICIO,y=PRECIO,color=PRODUCTO))+geom_point()
#ggplot(data=dfPreciosAndalucia,aes(x=INICIO,y=PRECIO,fill=SECTOR))+geom_dotplot(binwidth = 1.5)
```
