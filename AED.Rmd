...
- Analizar series temporales para respaldar todo lo anterior en base a eso
- Marcarnos un triple y añadir un dataset con una serie del IPC. ahi es cuando podremos decir si han tenido impacto los precios o no!
Pista: bajó el IPC de casi todo menos de los precios y verduras, pero hay que ver si todos los años suben por esas fechas y es algo habitual o si es exclusivo Covid.
