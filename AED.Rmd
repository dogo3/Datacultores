...
TODO->HECHO esta suma está mal porque hay una fila que tiene el total del año (la que ahora en fecha sale con NA). Quitar esa fila es más fácil
```{r}
...
# print(paste("Total exportaciones desde España toneladas:  ",totalImpKg/10))
