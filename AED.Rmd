...
dfMAPAConsumo_Gr<-dfMAPAConsumo_S %>%arrange(Producto,CCAA,Fecha)%>% group_by(Producto,CCAA)%>%mutate(`Diff Volumen (miles de kg)` =`Volumen (miles de kg)`-dplyr::lag(`Volumen (miles de kg)`))
