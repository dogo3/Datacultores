...
#TODO esta suma está mal porque hay una fila que tiene el total del año (la que ahora en fecha sale con NA). Sería todo/2 porque estamos sumando cada año dos veces. Quitar esa fila es más fácil
```{r}
